import { SelectionSetNode, FieldNode, FragmentSpreadNode, InlineFragmentNode, GraphQLNamedType, GraphQLSchema, SelectionNode, GraphQLObjectType, DirectiveNode } from 'graphql';
import { NormalizedScalarsMap, ConvertNameFn, LoadedFragment, GetFragmentSuffixFn } from './types.cjs';
import { BaseVisitorConvertOptions } from './base-visitor.cjs';
import { ParsedDocumentsConfig } from './base-documents-visitor.cjs';
import { LinkField, PrimitiveAliasedFields, PrimitiveField, BaseSelectionSetProcessor, NameAndType } from './selection-set-processor/base.cjs';
