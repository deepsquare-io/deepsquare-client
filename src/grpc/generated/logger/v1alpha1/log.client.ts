...
export class LoggerAPIClient implements ILoggerAPIClient, ServiceInfo {
  ...
  write(
    ...
    return stackIntercept<WriteRequest, WriteResponse>(
      "clientStreaming",
      this._transport,
      method,
      opt
  ...
  read(
    ...
    const method = this.methods[1],
      opt = this._transport.mergeOptions(options);
    return stackIntercept<ReadRequest, ReadResponse>(
      "serverStreaming",
      this._transport,
      method,
      opt,
  ...
  watchList(
    ...
    const method = this.methods[2],
      opt = this._transport.mergeOptions(options);
    return stackIntercept<WatchListRequest, WatchListResponse>(
      "serverStreaming",
      this._transport,
      method,
      opt,
